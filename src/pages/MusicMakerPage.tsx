        ...
        <div className="max-w-5xl mx-auto">
          <header className="text-center mb-16">
            <div className="inline-flex items-center gap-2 bg-purple-500/10 border border-purple-500/20 rounded-full px-5 py-2 mb-6">
              ...
              <span className="text-purple-300 text-sm font-medium">AI Music Maker</span>
            </div>
          ...
          <section className="mb-20 bg-white/5 border border-white/10 rounded-2xl p-8">
            ...
            <ul className="space-y-3 max-w-2xl mx-auto">
              <li className="flex gap-3 text-white/80"><Check className="w-5 h-5 text-emerald-400 shrink-0 mt-1" /> No commission on your streaming royalties.</li>
              <li className="flex gap-3 text-white/80"><Check className="w-5 h-5 text-emerald-400 shrink-0 mt-1" /> Blockchain-timestamped proof of authorship for every track.</li>
              <li className="flex gap-3 text-white/80"><Check className="w-5 h-5 text-emerald-400 shrink-0 mt-1" /> AI covers, videos and social creatives from the same account.</li>
              <li className="flex gap-3 text-white/80"><Check className="w-5 h-5 text-emerald-400 shrink-0 mt-1" /> Multi-artist manager panel for labels and agencies.</li>
            </ul>
          </section>
