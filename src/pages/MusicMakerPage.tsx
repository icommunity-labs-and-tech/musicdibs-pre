      ...
      <article className="pt-32 pb-20 px-6">
        <div className="max-w-5xl mx-auto">
          ...
          <section className="mb-20">
            <h2 className="text-3xl font-bold text-center mb-12 text-primary-foreground">Everything an AI music maker should do</h2>
          ...
          <section className="mb-20">
            <h2 className="text-3xl font-bold text-center mb-4 text-primary-foreground">Who uses the Musicdibs music maker</h2>
          ...
          <section className="mb-20">
            <h2 className="text-3xl font-bold text-center mb-10 text-primary-foreground">Traditional tools vs Musicdibs</h2>
              ...
              <table className="w-full min-w-[640px] text-sm">
                <thead>
                  <tr className="border-b border-page-border">
                    <th className="text-left px-5 py-4 text-page-fg-subtle font-bold text-xs uppercase tracking-wide">Aspect</th>
                ...
                <tbody>
                  {COMPARE.map((r, i) => (
                    <tr key={i} className={`border-b border-page-border last:border-b-0 ${i % 2 === 0 ? "bg-primary-foreground/[0.02]" : ""}`}>
                      ...
                      <td className="px-4 py-4 text-center text-page-fg-muted">{r.tools}</td>
          ...
          <section className="mb-20 bg-page-surface border border-page-border rounded-2xl p-8">
            <h2 className="text-2xl font-bold text-primary-foreground mb-6 text-center">Why creators pick Musicdibs</h2>
            <ul className="space-y-3 max-w-2xl mx-auto">
              <li className="flex gap-3 text-page-fg-muted"><Check className="w-5 h-5 text-success shrink-0 mt-1" /> No commission on your streaming royalties.</li>
              <li className="flex gap-3 text-page-fg-muted"><Check className="w-5 h-5 text-success shrink-0 mt-1" /> Blockchain-timestamped proof of authorship for every track.</li>
              <li className="flex gap-3 text-page-fg-muted"><Check className="w-5 h-5 text-success shrink-0 mt-1" /> AI covers, videos and social creatives from the same account.</li>
              <li className="flex gap-3 text-page-fg-muted"><Check className="w-5 h-5 text-success shrink-0 mt-1" /> Multi-artist manager panel for labels and agencies.</li>
            </ul>
          </section>
          ...
          <section className="text-center bg-gradient-to-r from-primary/10 to-brand/10 border border-primary/20 rounded-2xl p-12">
            ...
            <h2 className="text-3xl font-bold text-primary-foreground mb-4">Make a song. Release it today.</h2>
            <p className="text-page-fg-muted mb-8 max-w-xl mx-auto">Free to start. No credit card. Distribute your first single tomorrow.</p>
            <Link to="/login">
              <Button variant="hero" size="xl" className="font-semibold">
