...
const MODES = [
  {
    ...
    useCases: ["Transformar una melodía simple en una completa", "Añadir producción e instrumentos"],
  },
  {
  ...
  },
  {
    ...
    useCases: ["Continuar una demo", "Ampliar una intro", "Transformar una idea corta en canción completa"],
  },
];
...
const AIEnhance = () => {
  ...
  const handleGenerate = async () => {
    ...
    try {
      ...
      const response = await fetch(`${import.meta.env.VITE_SUPABASE_URL}/functions/v1/kie-enhance-generate`, {
        method: "POST",
        ...
        <div className="space-y-6">
          <div className="flex items-start justify-between gap-4">
            <div>
              ...
              <p className="text-muted-foreground mt-1">Trabaja sobre ideas musicales reales creadas por ti.</p>
            </div>
            <Button
              variant="ghost"
              size="sm"
          ...
          <Alert>
            ...
            <AlertDescription>
              La IA genera reinterpretaciones basadas en tu idea original. Los resultados pueden variar ligeramente —
          ...
          <div className="space-y-3">
            <h2 className="text-sm font-semibold text-muted-foreground uppercase tracking-wide">¿Qué quieres hacer?</h2>
          ...
          {/* ── Upload ──────────────────────────────────────────────────────── */}
          <div className="space-y-3">
            <h2 className="text-sm font-semibold text-muted-foreground uppercase tracking-wide">Tu audio</h2>
            <FileDropzone
          ...
          <div className="space-y-2">
            <div className="flex items-center justify-between">
              <label className="text-sm font-semibold">Describe el resultado (opcional pero recomendado)</label>
          ...
          {(selectedMode === "cover" || selectedMode === "extend") && (
            <div className="space-y-2">
              <label className="text-sm font-semibold text-muted-foreground">Idioma de la voz en el audio</label>
          ...
          <AnimatePresence>
            {isProcessing && (
              ...
              >
                ...
                <Progress value={jobStatus === "uploading" ? uploadProgress : undefined} className="h-1.5" />
              </motion.div>
            )}
          </AnimatePresence>
            ...
            {jobStatus === "failed" && genError && (
              ...
              >
                ...
                <div className="space-y-1">
                  ...
                  <p className="text-xs text-muted-foreground">No se han descontado créditos adicionales.</p>
                  <Button variant="ghost" size="sm" onClick={handleReset} className="gap-2 h-7 px-2 text-xs mt-1">
