...
const LegalValidity = () => {
  ...
  return (
    <div className="min-h-screen page-bg">
      <SEO title={t("legalValidity.title")} description={t("legalValidity.subtitle", "Conoce la validez legal de los certificados blockchain de Musicdibs para proteger tus derechos de autor.")} path="/legal-validity" />
      <Navbar />
