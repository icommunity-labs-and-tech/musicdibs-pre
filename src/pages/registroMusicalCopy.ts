...
export const REGISTRO_COPY: Record<RegistroLang, RegistroCopy> = {
  es: {
    ...
    heroCta: "🚀 Registra tu primera canción gratis",
    heroBenefits: ["1 registro gratuito", "Sin tarjeta", "En menos de 2 minutos"],
    heroExplore: "¿Ya sabes qué plan necesitas?",
    heroExploreLink: "Ver precios →",
  ...
  en: {
    ...
    heroCta: "🚀 Register your first song for free",
    heroBenefits: ["1 free registration", "No card needed", "Under 2 minutes"],
    heroExplore: "Already know which plan you need?",
    heroExploreLink: "View pricing →",
  ...
  "pt-BR": {
    ...
    heroCta: "🚀 Registre sua primeira música grátis",
    heroBenefits: ["1 registro grátis", "Sem cartão", "Em menos de 2 minutos"],
    heroExplore: "Já sabe qual plano precisa?",
    heroExploreLink: "Ver preços →",
