                    ...
                    <TooltipProvider>
                      <Tooltip>
                        <TooltipTrigger asChild>
                          <Button variant="ghost" size="icon" className="h-7 w-7" onClick={() => openFilesModal(p)}>
                            <Paperclip className="h-4 w-4" style={{ color: hasFiles(p) ? '#7C3AED' : undefined }} />
                          </Button>
                        </TooltipTrigger>
                        <TooltipContent>
          ...
          {selected && (
            <div className="space-y-3 text-sm">
              <div className="grid grid-cols-[140px_1fr] gap-y-2">
                ...
                {(selected.audio_file_path || selected.media_file_path) && (
                  <>
                    ...
                    <Button
                      ...
                      onClick={() => { setSelected(null); openFilesModal(selected); }}
                    >
                      <Paperclip className="h-3.5 w-3.5" /> Ver archivos adjuntos
                    </Button>
                  </>
                )}
                {selected.team_notes && (
