      ...
      distribution: {
        ...
        faq: {
          ...
          items: [
            ...
            { q: 'Como funcionam os royalties ou comissões pelas minhas reproduções?', a: 'Com a Musicdibs, você ficará com 95% da receita gerada pelas suas reproduções. Atualmente, o mercado oferece cerca de 80% mais uma taxa anual. No nosso caso, incluímos tudo em um pacote para que você obtenha as melhores condições.' },
