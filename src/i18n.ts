...
const resources = {
  ...
  en: {
    translation: {
      ...
      hero: {
        title: 'Create. Protect. Distribute.', highlight: 'Promote.', subtitle_prefix: 'The all-in-one platform for artists: create or improve your music, register it with legal validity and', subtitle_strong: 'launch it to the world in minutes.', legal_more: '+info', cta_start: '🚀 Create free account', cta_how: '▶ See how it works in 20s',
      },
      why: {
  ...
  en: {
    aiStudio: {
      ...
      modules: {
        ...
        singYourSong: { title: 'Voice Tools', desc: 'Your AI vocal studio: clone your voice, sing in 29 languages, translate audio and much more' },
        virtualArtists: { title: 'My Virtual Artists', desc: 'Save your voice and style settings to create consistent songs with your artists.' },
        enhance: { title: 'Enhance your songs', desc: 'Upload your demos and add production, extend your idea to a full song, or generate new versions.' },
      },
      features: {
  ...
  es: {
    creditPricing: {
      ...
      descriptions: {
        ...
        one_click_create: 'Genera una canción automáticamente con un solo clic',
  ...
  en: {
    creditPricing: {
      ...
      descriptions: {
        ...
        one_click_create: 'Automatically generate a song with one click',
  ...
  'pt-BR': {
    creditPricing: {
      ...
      features: {
        ...
        one_click_create: 'Música em 1 clique',
