...
const resources = {
  ...
  'pt-BR': {
    translation: {
      nav: { pricing: 'Preços', faq: 'FAQ', support: 'Suporte', news: 'Notícias', services: 'Serviços', distribution: 'Distribuição de obras', access: 'Acesso', info: 'Informações', market: 'Marketplace de obras', dibs: 'DIBS Token', verifier: 'Verificador de obras', login: 'Crie, proteja, lance, promova', contact: 'Contato', howItWorks: 'Como funciona?', accessServices: 'Entrar ou Cadastre-se', marketing: 'Marketing e Promos', distributionPromo: 'Distribuição e Promoção', partners: 'Seja um Partner', legalValidity: 'Validade jurídica' },
