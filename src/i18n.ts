...
const aiStudioRootTranslations: Record<string, { aiStudio: Record<string, any> }> = {
  es: {
    aiStudio: {
      ...
      pageSubtitle: 'Crea canciones, portadas y videoclips desde un solo lugar.\nMejora tus canciones y promociona todas tus creaciones.',
      noCredits: 'Sin créditos',
      comingSoon: 'Próximamente',
      creditPerUse: 'crédito por uso',
      creditsPerUse: 'créditos por uso',
  ...
  en: {
    aiStudio: {
      ...
      pageTitle: 'AI Music Studio',
      pageSubtitle: 'Create songs, covers and videoclips from one place.\nEnhance your songs and promote all your creations.',
      noCredits: 'No credits',
      comingSoon: 'Coming soon',
      creditPerUse: 'credit per use',
      creditsPerUse: 'credits per use',
