  ...
  es: {
    translation: {
      ...
      distro: {
        ...
        world: { title: 'Distribución', desc: 'Publica tus canciones en más de 220 plataformas digitales y conserva hasta el 100% de tus royalties.', cta: 'Quiero distribuir mi música' },
      ...
      calculator: {
        ...
        subtitle: 'Musicdibs ofrece uno de los sistemas de distribución más rentables, recibe hasta el 100% de tus royalties.',
        ...
        advantage_desc: 'Gracias a nuestro 100% de royalties, el más alto del mercado, maximizas tus ingresos por cada reproducción.',
        disclaimer: '* Estimación basada en un pago medio por stream de 0,004€. Los ingresos reales pueden variar según la plataforma, país y tipo de suscripción del oyente. Musicdibs no se queda ninguna comisión: el 100% se refiere a lo que Musicdibs recibe del distribuidor/plataforma. Las plataformas de streaming (Spotify, Apple Music, etc.) retienen su parte antes del reparto, igual que hacen con cualquier distribuidor.',
      ...
      distribution: {
        ...
        description: 'Llega a más de 220 DSPs y quédate con el 100% de tus royalties, muy por encima de la media del mercado (que suele retener entre el 20% y el 25%).',
        ...
        faq: {
          ...
          items: [
            ...
            { q: '¿Cómo funcionan los royalties o comisiones por mis reproducciones?', a: 'Con Musicdibs, te quedarás con el 100% de los ingresos generados por tus reproducciones. Actualmente, el mercado ofrece alrededor del 80% más una cuota anual. En nuestro caso, lo hemos incluido en un paquete para que obtengas las mejores condiciones.' },
  ...
  en: {
    translation: {
      ...
      calculator: {
        ...
        disclaimer: '* Estimate based on an average pay per stream of €0.004. Actual earnings may vary depending on the platform, country and listener subscription type. Musicdibs keeps 0% commission: the 100% figure refers to what Musicdibs receives from the distributor/platform. Streaming platforms (Spotify, Apple Music, etc.) retain their own share before payout, as they do with any distributor.',
        competitors: { musicdibs: 'Musicdibs', distrokid: 'DistroKid', cdbaby: 'CD Baby', tunecore: 'TuneCore' },
        tabs: {
      ...
      distribution: {
        ...
        faq: {
          ...
          items: [
            ...
            { q: 'How do royalties or commissions for my plays work?', a: 'With Musicdibs, you\'ll keep 100% of the revenue generated by your streams. Currently, the market offers around 80% plus an annual fee. We\'ve included it all in a package so you get the best conditions.' },
  ...
  'pt-BR': {
    translation: {
      ...
      calculator: {
        ...
        disclaimer: '* Estimativa baseada em um pagamento médio por stream de €0,004. Os ganhos reais podem variar conforme a plataforma, país e tipo de assinatura do ouvinte. A Musicdibs não fica com nenhuma comissão: os 100% referem-se ao que a Musicdibs recebe do distribuidor/plataforma. As plataformas de streaming (Spotify, Apple Music, etc.) retêm sua parte antes do repasse, como fazem com qualquer distribuidor.',
        competitors: { musicdibs: 'Musicdibs', distrokid: 'DistroKid', cdbaby: 'CD Baby', tunecore: 'TuneCore' },
        tabs: {
      ...
      distribution: {
        ...
        description: 'Alcance mais de 220 DSPs e fique com 100% dos seus royalties, muito acima da média do mercado (que normalmente retém entre 20% e 25%).',
        ...
        faq: {
          ...
          items: [
            ...
            { q: 'Como funcionam os royalties ou comissões pelas minhas reproduções?', a: 'Com a Musicdibs, você ficará com 100% da receita gerada pelas suas reproduções. Atualmente, o mercado oferece cerca de 80% mais uma taxa anual. No nosso caso, incluímos tudo em um pacote para que você obtenha as melhores condições.' },
