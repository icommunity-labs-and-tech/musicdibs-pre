      ...
      distribution: {
        ...
        faq: {
          ...
          items: [
            ...
            { q: '¿Cómo funcionan los royalties o comisiones por mis reproducciones?', a: 'Con Musicdibs, te quedarás con el 95% de los ingresos generados por tus reproducciones. Actualmente, el mercado ofrece alrededor del 80% más una cuota anual. En nuestro caso, lo hemos incluido en un paquete para que obtengas las mejores condiciones.' },
