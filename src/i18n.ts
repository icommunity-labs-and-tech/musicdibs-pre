...
const resources = {
  ...
  en: {
    translation: {
      ...
      hero: {
        title: 'Create. Protect. Distribute.', highlight: 'Promote.', subtitle_prefix: 'The all-in-one platform for artists: create or enhance your music, register it with legal validity and', subtitle_strong: 'launch it to the world in minutes.', legal_more: '+info', cta_start: '🚀 Create free account', cta_how: '▶ See how it works in 20s',
      },
      why: {
  ...
  'pt-BR': {
    translation: {
      ...
      hero: { title: 'Crie. Proteja. Distribua.', highlight: 'Promova.', subtitle_prefix: 'A plataforma tudo-em-um para artistas: crie ou melhore sua música, registre-a com validade legal e', subtitle_strong: 'lance-a ao mundo em minutos.', legal_more: '+info', cta_start: '🚀 Criar conta grátis', cta_how: '▶ Veja como funciona em 20s' },
