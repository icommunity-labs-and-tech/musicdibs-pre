...
const COPY_ES = {
  ...
  closingCta: {
    ...
    footnote: "Desde €6,90/mes · Sin permanencia · 3 créditos gratis al registrarte (1 para registrar tu canción)",
  },
};
...
const COPY_EN: FeaturesCopy = {
  ...
  closingCta: {
    ...
    footnote: "From €6.90/month · No commitment · 3 free credits when you sign up (1 to register your song)",
  },
};
...
const COPY_PT: FeaturesCopy = {
  ...
  closingCta: {
    ...
    footnote: "A partir de €6,90/mês · Sem fidelidade · 3 créditos grátis ao se cadastrar (1 para registrar sua música)",
  },
};
