  ...
  return (
    <Dialog open={open} onOpenChange={(v) => {
      ...
      <DialogContent className="max-w-lg max-h-[80vh] flex flex-col">
        ...
        <div className="flex items-start gap-2 rounded-md border border-warning/40 bg-warning dark:bg-warning/10 px-3 py-2 text-xs text-warning dark:text-warning">
