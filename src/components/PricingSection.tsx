...
export const PricingSection = () => {
  ...
  const launchCheckout = useCallback(async (planId: string, guestEmail?: string) => {
    ...
    // FIX 2026-09-08: centralizado en getAttributionForCheckout(), que ademas
    // incluye el gclid (identificador de clic de Google Ads) para poder saber
    // con certeza que compras vienen de las campañas.
