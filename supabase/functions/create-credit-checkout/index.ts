...
serve(async (req) => {
  ...
  try {
    ...
    for (const key of ["utm_source", "utm_medium", "utm_campaign", "utm_content", "utm_term", "gclid", "gbraid", "wbraid", "coupon_code", "referrer_code", "referrer", "landing_path", "attributed_campaign_name"]) {
