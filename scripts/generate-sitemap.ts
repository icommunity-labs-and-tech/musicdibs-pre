...
const staticEntries: SitemapEntry[] = [
  ...
  { path: "/en/testimonials", changefreq: "monthly", priority: "0.6" },
  { path: "/pt/depoimentos", changefreq: "monthly", priority: "0.6" },
  { path: "/legal-validity", changefreq: "yearly", priority: "0.5" },
  { path: "/registro-obras-musicales", changefreq: "monthly", priority: "0.9" },
  { path: "/derechos-autor-musica", changefreq: "monthly", priority: "0.9" },
  { path: "/copyright-a-song", changefreq: "monthly", priority: "0.9" },
  { path: "/register-a-song", changefreq: "monthly", priority: "0.9" },
  ...
  { path: "/pt/features", changefreq: "monthly", priority: "0.8" },
  { path: "/pt/distribution", changefreq: "monthly", priority: "0.8" },
  { path: "/pt/legal-validity", changefreq: "yearly", priority: "0.5" },
  { path: "/pt/marketing", changefreq: "monthly", priority: "0.8" },
  { path: "/pt/partners", changefreq: "monthly", priority: "0.6" },
