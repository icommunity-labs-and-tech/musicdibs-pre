...
- Suno API > voice [Suno Voice Generation Callback](https://docs.kie.ai/suno-api/suno-voice-generate-callback.md): 
- Suno API > voice [Suno Voice Validation Phrase Callback](https://docs.kie.ai/suno-api/suno-voice-validate-callback.md): 
...
- Suno API > voice [Suno Voice 生成回调](https://docs.kie.ai/cn/suno-api/suno-voice-generate-callback.md): 
- Suno API > voice [Suno Voice 验证短句回调](https://docs.kie.ai/cn/suno-api/suno-voice-validate-callback.md): 
...
- Suno API > voice [Suno Voice Generate Verification Phrase API](https://docs.kie.ai/suno-api/suno-voice-validate.md): Generate a validation phrase for the Suno Voice custom voice workflow.
- Suno API > voice [Suno Voice Get Verification Phrase API](https://docs.kie.ai/suno-api/suno-voice-validate-info.md): Query the validation phrase generation result for a Suno Voice task.
- Suno API > voice [Suno Voice Create Custom Voice API](https://docs.kie.ai/suno-api/suno-voice-generate.md): Generate a custom Suno Voice after the user reads the validation phrase.
- Suno API > voice [Suno Voice Get Custom Voice Records](https://docs.kie.ai/suno-api/suno-voice-record-info.md): Query the custom Suno Voice generation result.
- Suno API > voice [Suno Voice Regenerate Verification Phrase](https://docs.kie.ai/suno-api/suno-voice-regenerate.md): Regenerate the validation phrase for an existing Suno Voice task.
- Suno API > voice [Suno Voice Check Availability API](https://docs.kie.ai/suno-api/suno-voice-check-voice.md): Check whether a generated Suno custom voice is available.
...
- Veo3.1 API [生成veo3.1视频](https://docs.kie.ai/cn/veo3-api/generate-veo-3-video.md): ### Veo 3.1 生成 API
...
- Suno API > Sounds Generation [生成声音](https://docs.kie.ai/cn/suno-api/generate-sounds.md): 用于创建声音生成任务（Sounds Task）。支持设置循环、节拍（BPM）、音调（Key）以及歌词字幕抓取等功能。
- Suno API > voice [Suno Voice生成验证短句接口](https://docs.kie.ai/cn/suno-api/suno-voice-validate.md): 生成 Suno Voice 自建音色流程所需的验证短句。
- Suno API > voice [Suno Voice获取验证短句接口](https://docs.kie.ai/cn/suno-api/suno-voice-validate-info.md): 查询 Suno Voice 任务的验证短句生成结果。
- Suno API > voice [Suno Voice自建音色生成接口](https://docs.kie.ai/cn/suno-api/suno-voice-generate.md): 在用户录制验证短句后，生成 Suno Voice 自建音色。
- Suno API > voice [Suno Voice获取自建音色记录](https://docs.kie.ai/cn/suno-api/suno-voice-record-info.md): 查询 Suno Voice 自建音色生成结果。
- Suno API > voice [Suno Voice 重新生成验证短句](https://docs.kie.ai/cn/suno-api/suno-voice-regenerate.md): 为已有的 Suno Voice 任务重新生成验证短句。
- Suno API > voice [Suno Voice检查是否可用接口](https://docs.kie.ai/cn/suno-api/suno-voice-check-voice.md): 检查生成的 Suno 自建音色是否可用。
